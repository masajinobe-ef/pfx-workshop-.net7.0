...
namespace pfx_workshop_.net7._0.Pages
{
    public partial class Products : Page
    {
                ...
                {
                    {
                        ...
                        if (columnBinding != null)
                        {
                            ...
                            int id = Convert.ToInt32(row["p_id"]);
                            ...
                            try
                            {
                                using (var conn = new NpgsqlConnection(connectionString))
                                {
                                    ...
                                    {
                                        cmd.Connection = conn;
                                        cmd.CommandText = $"UPDATE public.\"Product\" SET {columnName} = @newValue WHERE p_id = @id;";
        ...
        {
            if (ProductsDataGrid.SelectedItem is DataRowView row && row != null)
            {
                int id = Convert.ToInt32(row["p_id"]);
