    ...
    public partial class Supplier : Page
    {
        ...
        private void Refresh()
        {
            try
            {
                ...
                {
                    conn.Open();
                    string sql = "SELECT * FROM public.\"Supplier\";";
        ...
        private void SupplierDataGrid_CellEditEnding(object sender, DataGridCellEditEndingEventArgs e)
        {
        ...
        {
            if (SupplierDataGrid.SelectedItem is DataRowView row && row != null)
            {
                int id = Convert.ToInt32(row["s_id"]);
