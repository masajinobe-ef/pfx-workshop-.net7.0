...
namespace pfx_workshop_.net7._0.Pages
{
    public partial class Clients : Page
    {
                ...
                {
                    {
                        ...
                        if (columnBinding != null)
                        {
                            ...
                            int id = Convert.ToInt32(row["c_id"]);
                            ...
                            try
                            {
                                using (var conn = new NpgsqlConnection(connectionString))
                                {
                                    ...
                                    {
                                        cmd.Connection = conn;
                                        cmd.CommandText = $"UPDATE public.\"Client\" SET {columnName} = @newValue WHERE c_id = @id;";
        ...
        {
            if (ClientsDataGrid.SelectedItem is DataRowView row && row != null)
            {
                int id = Convert.ToInt32(row["c_id"]);
